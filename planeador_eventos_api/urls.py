...
urlpatterns = [
    ...
    path('api/planeador_eventos_api/events/user/<uuid:user_uuid>/', get_events_by_user_uuid),
    ...
    path('api/planeador_eventos_api/services/type/<str:service_type>', get_services_by_type),
